"""TASK-081A create sales payment operation table.

Revision ID: task_081a_create_sales_payment_operations
Revises: task_080a_create_factory_statement_payment_operations
...
revision = "task_081a_create_sales_payment_operations"
down_revision = "task_080a_create_factory_statement_payment_operations"
branch_labels = None
depends_on = None

_SCHEMA_NAME = "ly_schema"
_PAYMENT_TABLE = "ly_sales_payment_entry"
_OPERATION_TABLE = "ly_sales_payment_entry_operation"
...
def _create_operation_table(bind, schema: str | None) -> None:
    ...
    op.create_table(
        ...
        sa.Column("payment_entry_id", id_type, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_ly_sales_payment_op_payment",
        ),
        sa.CheckConstraint(
...
def upgrade() -> None:
    ...
    _create_index_if_needed(
        ...
        ["payment_entry_id", "operation_type", "created_at"],
    )
    _create_index_if_needed(
        bind,
        schema,
