"""TASK-062C extend sample idempotency operation constraint.

Revision ID: task_062c_extend_sample_idempotency_operations
Revises: task_062b_create_sample_tables
...
revision = "task_062c_extend_sample_idempotency_operations"
down_revision = "task_062b_create_sample_tables"
branch_labels = None
depends_on = None
...
_OPERATIONS = "('create','update','submit','seal','reverse','convert','deactivate','create_node','delete_node')"
_OLD_OPERATIONS = "('create','update','submit','seal','reverse','convert','create_node')"
