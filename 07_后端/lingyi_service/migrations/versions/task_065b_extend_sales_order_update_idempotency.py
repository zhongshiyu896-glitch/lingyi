"""TASK-065B allow sales order draft update idempotency.

Revision ID: task_065b_extend_sales_order_update_idempotency
Revises: task_065a_add_bom_company_style_master_link
...
revision = "task_065b_extend_sales_order_update_idempotency"
down_revision = "task_065a_add_bom_company_style_master_link"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    _replace_operation_constraint("operation IN ('create_draft','cancel_draft')")
