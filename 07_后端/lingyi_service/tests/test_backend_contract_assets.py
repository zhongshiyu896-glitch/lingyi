...
class BackendContractAssetsTest(unittest.TestCase):
    ...
    def test_task2_task3_contract_handoff_documents_are_present(self) -> None:
        ...
        self.assertEqual(task2_json["backend_catalog_counts"], {"A": 267, "B": 16, "C": 7, "D": 11})
        self.assertEqual(task2_json["page_matrix_counts"]["total_pages"], 60)
        self.assertEqual(task2_json["page_matrix_counts"]["real_backend_route"], 60)
        self.assertEqual(task2_json["page_matrix_counts"]["api_path_miss"], 0)
        self.assertEqual(task2_json["page_matrix_counts"]["missing_api_path"], 0)
