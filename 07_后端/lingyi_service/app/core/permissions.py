...
PRODUCTION_TRACKING_EXCEPTION = "production:tracking_exception"
PRODUCTION_TRACKING_NODE = "production:tracking_node"
PRODUCTION_FOLLOWUP_TEMPLATE_WRITE = "production:followup_template_write"
PRODUCTION_QUOTE_WRITE = "production:quote_write"
...
FACTORY_STATEMENT_PAYMENT_CREATE = "factory_statement:payment_create"
FACTORY_STATEMENT_PAYMENT_CANCEL = "factory_statement:payment_cancel"
...
ALL_PRODUCTION_ACTIONS = {
    ...
    PRODUCTION_TRACKING_EXCEPTION,
    PRODUCTION_TRACKING_NODE,
    PRODUCTION_FOLLOWUP_TEMPLATE_WRITE,
    PRODUCTION_QUOTE_WRITE,
...
ALL_PERMISSION_ACTIONS = {
    ...
    PERMISSION_GOVERNANCE_DIAGNOSTIC,
}
...
MODULE_ACTION_REGISTRY: dict[str, set[str]] = {
    ...
    "permission": set(ALL_PERMISSION_ACTIONS),
