...
class SalesInventoryService:
    ...
    def _build_native_sales_order_list_item(self, order: LySalesOrder) -> SalesOrderListItem:
        ...
        return SalesOrderListItem(
            ...
            quote_status=self._text(getattr(order, "quote_status", None)) or "未核价",
            quote_no=self._text(getattr(order, "quote_no", None)),
            quote_amount=self._decimal_or_none(getattr(order, "quote_amount", None)),
            quote_unit_price=self._decimal_or_none(getattr(order, "quote_unit_price", None)),
            quote_material_cost=self._decimal_or_none(getattr(order, "quote_material_cost", None)),
            quote_labor_cost=self._decimal_or_none(getattr(order, "quote_labor_cost", None)),
            quote_management_fee=self._decimal_or_none(getattr(order, "quote_management_fee", None)),
            quote_other_fee=self._decimal_or_none(getattr(order, "quote_other_fee", None)),
            quote_total_cost=self._decimal_or_none(getattr(order, "quote_total_cost", None)),
            gross_profit=self._decimal_or_none(getattr(order, "gross_profit", None)),
            gross_margin_rate=self._decimal_or_none(getattr(order, "gross_margin_rate", None)),
        )
