...
const liveModules = read('src/config/liveModules.ts')
...
assertContains(liveModules, "LIVE_MODULES = ['bom']", 'live module whitelist')
assertContains(appShell, "from '@/config/liveModules'", 'App.vue live module whitelist import')
assertContains(appShell, 'allYisuanShellMenuGroups', 'App.vue complete menu registry')
assertContains(appShell, 'isLiveModule(item.module)', 'App.vue live menu filter')
assertContains(appShell, 'group.items.length > 0', 'App.vue empty parent menu hidden')
assertContains(homePage, "from '@/config/liveModules'", 'HomePage.vue live module whitelist import')
assertContains(homePage, 'allSidebarGroups', 'HomePage.vue complete sidebar registry')
assertContains(homePage, 'isLiveModule(item.module)', 'HomePage.vue live sidebar filter')
assertContains(homePage, 'group.items.length > 0', 'HomePage.vue empty parent menu hidden')
