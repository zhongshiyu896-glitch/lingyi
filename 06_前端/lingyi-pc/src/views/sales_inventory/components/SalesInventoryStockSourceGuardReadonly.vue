...
import type { SalesInventoryStockSourceGuardReadonlyViewSummary } from '@/views/sales_inventory/composables/useSalesInventoryStockSourceGuardReadonly'

defineProps<{
  summary: SalesInventoryStockSourceGuardReadonlyViewSummary
}>()
</script>
