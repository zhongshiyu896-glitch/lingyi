      ...
      <template v-else>
        <el-tabs v-model="activeTab">
          <el-tab-pane label="生产-库存-质量" name="work_order">
            ...
            <el-table :data="workOrderTrail?.stock_entries || []" border v-loading="workOrderLoading" empty-text="暂无库存流水事实，请调整筛选条件后重试">
            ...
            <el-table :data="workOrderTrail?.quality_inspections || []" border v-loading="workOrderLoading" empty-text="暂无质量检验事实，请调整筛选条件后重试">
          ...
          <el-tab-pane label="销售-库存-质量" name="sales_order">
            ...
            <el-table :data="salesOrderTrail?.delivery_notes || []" border v-loading="salesOrderLoading" empty-text="暂无交付出库事实，请调整筛选条件后重试">
            ...
            <h3 class="section-title">质量检验事实</h3>
            <el-table :data="salesOrderTrail?.quality_inspections || []" border v-loading="salesOrderLoading" empty-text="暂无质量检验事实，请调整筛选条件后重试">
              <el-table-column prop="inspection_no" label="检验单号" min-width="170" />
              <el-table-column prop="inspection_date" label="检验日期" width="120" />
              <el-table-column prop="item_code" label="物料" min-width="130" />
              <el-table-column prop="warehouse" label="仓库" min-width="140" />
