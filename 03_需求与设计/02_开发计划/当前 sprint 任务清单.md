...
- TASK-005C4 利润模型本地仓库基线提交：任务单已下发，路径 `/03_需求与设计/02_开发计划/TASK-005C4_利润模型本地仓库基线提交_工程任务单.md`。将 TASK-005C~C3 新增利润模型、schema、来源映射服务、迁移、测试和配套文档按白名单纳入本地 commit；审计通过前不得进入 TASK-005D/TASK-006。
