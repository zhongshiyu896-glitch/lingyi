...
- TASK-005D6 D5 任务单文档基线提交：任务单已下发，路径 `/03_需求与设计/02_开发计划/TASK-005D6_D5任务单文档基线提交_工程任务单.md`。只允许 docs-only 将 D5 任务单、D6 任务单和必要架构文档更新纳入本地 commit；审计通过前不得进入 TASK-005E/TASK-006。
