# TASK-Z044B-12-REGRESSION-CAND002 CAND002 回归报告
...
## Runtime Evidence
- route_evidence: 04_测试与验收/测试证据/z044_cand002_report_export_lock_readback_regression/route_evidence.json
- screenshot: 04_测试与验收/测试证据/z044_cand002_report_export_lock_readback_regression/reports_catalog_regression_screenshot.png
- dom_anchors_evidence: 04_测试与验收/测试证据/z044_cand002_report_export_lock_readback_regression/dom_anchors_evidence.json
- guarded_readonly_state_evidence: 04_测试与验收/测试证据/z044_cand002_report_export_lock_readback_regression/guarded_readonly_state_evidence.json
- network_write_request_observation: 04_测试与验收/测试证据/z044_cand002_report_export_lock_readback_regression/network_write_request_observation.json
...
## Screenshot
- path: 04_测试与验收/测试证据/z044_cand002_report_export_lock_readback_regression/reports_catalog_regression_screenshot.png
...
- Z044-CAND-002 B11 auth_401_count=25 readonly fallback risk
- Z044-CAND-002 B12 observed auth_401_count=25 readonly fallback risk
