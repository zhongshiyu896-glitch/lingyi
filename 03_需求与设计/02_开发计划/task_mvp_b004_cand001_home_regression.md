...
- screenshots:
  - `03_需求与设计/02_开发计划/evidence/mvp_b004_cand001_home_regression/mvp_b004_home_1440x1200.png`
  - `03_需求与设计/02_开发计划/evidence/mvp_b004_cand001_home_regression/mvp_b004_dashboard_overview_1440x1200.png`
- dom_anchors_observed: `8/8`
- local_write_loop_evidence:
  - scenario_tag: `Z003-WAREHOUSE-20260531-489`
  - create_or_update_success: `true`
  - save_success: `true`
  - draft_id_created: `true` (`draft_id=14`)
...
- network_write_observation:
  ...
  - write requests only local-dev path:
    - `POST /api/warehouse/stock-entry-drafts` -> `201`
    - `POST /api/warehouse/stock-entry-drafts/14/cancel` -> `200`
- typecheck:
...
- local_dev_started: `false` (reused existing `uvicorn app.local_dev:app`)
- local_dev_stopped: `false`

## SCOPE_GUARD
- authorized_changed_files_only: `true`
- local_dev_py_status: `untracked_support_file_governed`
